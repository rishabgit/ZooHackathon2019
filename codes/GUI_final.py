...
class graphscreen(Frame, Label):
    ...
    def __init__(self, parent, name, title, tags, price, leng, addgraph, maxi, mini):
        ...
        Label(self.sideFrame, width=28, text=tags, bg='white').grid(row=4, column=0)
        ...
        Label(self.sideFrame, width=28, text=leng, bg='white').grid(row=6, column=0)
        ...
        Label(self.sideFrame, width=28, text='%d - %d'%(mini,maxi), bg='white').grid(row=8, column=0)
        ...
        self.g2.bar(['Jan','Feb','March','April', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], addgraph, width=0.4, color='green')
        ...
        self.g2=self.f.add_subplot(111)
        self.g2.plot(['Jan','Feb','March','April', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], price, color='green')
...
def search_f():
    tags, price,totadv, addgraph, maxi, mini=data(search.get())
    pi=graphscreen(root, 'pi', 'GTA', tags, price, totadv, addgraph, maxi, mini)
